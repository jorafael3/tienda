...
INSERT INTO `parametros_horarios` VALUES (1,'Lun - Vie','08:30:00','20:00:00','2024-04-07 20:18:50',1),(2,'Sabados','10:00:00','20:00:00','2024-04-07 20:18:50',1);
...
CREATE TABLE `parametros_tienda` (
  ...
  `fecha_creado` datetime DEFAULT current_timestamp(),
  `TIENDA_ID` varchar(500) DEFAULT NULL,
  `map_ubicacion` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `parametros_tienda` VALUES (1,'TIENDA NOMBRE','jalvaradoe3@gmail.com','3245 Abbot Kinney BLVD –\r\nPH Venice, CA 124','guayaquil','GUayas','90010','Ecuador','1111111','22222222','2024-04-04 10:11:29','jku(7jsjoaom*o0w9aslla','https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3986.7582102386937!2d-79.9089865459313!3d-2.2441782988680283!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x902d6fcf5606dbd5%3A0xd791b7e307d9b5fa!2sCasa%20Ari%20Cabrera%20Vega!5e0!3m2!1ses-419!2sec!4v1712538051573!5m2!1ses-419!2sec'),(2,'TIENDA 2','jalvaradoe3@gmail.com','av 123','guayaquil','GUayas','90010','Ecuador','1111111','22222222','2024-04-04 10:11:29',NULL,NULL);
...
CREATE TABLE `productos_categorias` (
  ...
  `cat_icon` varchar(1000) DEFAULT NULL,
  `fecha_creado` datetime DEFAULT current_timestamp(),
  `tienda_id` int(11) DEFAULT NULL,
...
INSERT INTO `productos_categorias` VALUES (1,'HAMBURGUESAS','Productos relacionados con hamburguesas','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s','2024-04-03 17:59:18',1,1),(2,'BEBIDAS','Bebidas refrescantes y energéticas','https://img.freepik.com/vector-premium/bebida-gaseosa-o-refresco-estilo-plano-dibujos-animados-diseno-concepto-bebidas-fondo-blanco-aislado_339032-2490.jpg','2024-04-03 18:02:25',1,2),(3,'POSTRES','Deliciosos postres y dulces','https://png.pngtree.com/png-clipart/20210128/ourmid/pngtree-cream-cake-dessert-png-image_2836015.jpg','2024-04-04 18:02:25',1,3),(4,'SNACKS','adasdasd',NULL,'2024-04-14 20:26:40',1,4);
...
CREATE TABLE `productos_fichero` (
  ...
  `prod_discount` int(11) DEFAULT 0,
  `prod_discount_type` int(11) DEFAULT 0,
  `prod_discount_value` float DEFAULT 0,
  `prod_proveedor_id` int(11) DEFAULT NULL,
  `prod_agotado` int(11) DEFAULT 0,
...
INSERT INTO `productos_fichero` VALUES (1,'Hamburguesa Clásica','HBG001','Hamburguesa clásica con carne de res, lechuga, tomate y queso',5.99,3.5,1,2,1,1,1,50,1,1,50,1,0,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 17:58:55','2024-04-14 23:19:31'),(2,'Hamburguesa de Pollo','HBG002','Hamburguesa de pollo con lechuga, tomate y mayonesa',6.49,4,1,2,1,1,1,50,1,0,2,1,0,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 17:58:55','2024-04-15 00:04:49'),(3,'Hamburguesa Vegetariana','HBG003','Hamburguesa vegetariana con falafel, lechuga, tomate y salsa de tahini',7.99,5,1,2,1,1,1,30,0,0,0,1,1,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 17:58:55','2024-04-14 23:06:58'),(4,'Hamburguesa BBQ','HBG004','Hamburguesa con salsa barbacoa, cebolla caramelizada y queso cheddar',6.99,4.5,1,2,1,1,1,40,0,0,0,1,0,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 18:02:01','2024-04-14 23:05:57'),(5,'Hamburguesa Picante','HBG005','Hamburguesa con jalapeños, guacamole y salsa picante',7.49,5,1,2,1,1,1,30,0,0,0,1,0,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 18:02:01','2024-04-14 23:05:57'),(6,'Hamburguesa de Pavo','HBG006','Hamburguesa de pavo con lechuga, tomate y mostaza',6.49,4,1,2,1,1,1,50,0,0,0,1,0,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 18:02:01','2024-04-14 23:05:57'),(7,'Coca-Cola','CC001','Refresco de cola carbonatado',1.99,1,1,2,2,2,1,200,0,0,0,1,0,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 18:03:47','2024-04-14 23:05:57'),(8,'Jugo de Naranja','JN001','Jugo de naranja natural exprimido',2.49,1.5,1,1,2,2,1,150,0,0,0,1,0,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 18:03:47','2024-04-14 23:05:57'),(9,'Helado de Vainilla','HV001','Helado de vainilla cremoso',3.99,2,1,1,3,5,1,100,0,0,0,1,0,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 18:03:55','2024-04-14 23:05:57'),(10,'Tarta de Manzana','TM001','Tarta de manzana casera con canela',5.49,3,1,1,3,5,1,50,0,0,0,1,0,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzWGfd1JADxHpATx3AfNO1jrhB7z1D48gVP6uYq-nxQw&s',1,'2024-04-03 18:03:55','2024-04-14 23:05:57');
...
-- Dump completed on 2024-04-14 20:53:46
